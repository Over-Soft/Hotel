	...
	class Generaxml extends Invoice
	{
		...
		function Consulta_Ticket(){
			...
			/*$params=array('user'=>'20545756022MODDATOS',
				'pass'=>'moddatos');*/
				$params=array('user'=>'20545756022HOTELES1',
				'pass'=>'california');
			...
			try {
				...
				try {
					...
					if($respuesta):
			            ...
			            $link->query("UPDATE alquilerhabitacion SET mensaje_respuesta='".$res['DESCRIPCION']."' WHERE ticket ='".$this->ticket."'");
