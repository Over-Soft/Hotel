                                  ...
                                  <tr>
                                    <td width="894" height="30" bgcolor="#FFFFFF" class="textoContenido"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                                      <tr>
                                        ...
                                        <!--Adicional para 12 horas-->

                                        <tr>
	                                        <td width="200" height="30" bgcolor="#FFFFFF" ><span class="textoContenido" style="color:#00A230;"><strong>  <i class="fa fa-clock-o  fa-lg"></i> Alquiler por Horas </strong></span></td>
	                                        <td width="211" height="30" bgcolor="#FFFFFF"><input name="txtcostohoras12" type="text" class="textbox" id="txtcostohoras12" style="text-align:right; width:85%;" value="<?php echo $xpreciohora12;?>" readonly ></td>
	                                        <td width="356" height="30"><h3 class="textoContenido" style="margin:0px; padding:0px;">(Por 12 horas)
	                                        ...
	                                        <td width="150" align="center" bgcolor="#FFFFFF">
	                                          ...
	                                          <button type="button" class="btnnegro" style="border:0px; cursor:pointer;" onClick="document.form1.action='include/alquiler/prg_alquiler-nuevo-tmp.php?idtipo=6'; document.form1.submit()";> <i class="fa fa-plus-square"></i> Agregar </button>
                                  ...
                                  <tr>
                                    <td height="30" bgcolor="#FFFFFF" class="textoContenido"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                                      <tr>
                                        ...
                                        <td width="161" align="center" bgcolor="#FFFFFF"><button type="button" class="btnnegro" style="border:0px; cursor:pointer;" onClick="document.form1.action='include/alquiler/prg_alquiler-nuevo-tmp.php?idtipo=5'; document.form1.submit()";> <i class="fa fa-plus-square"></i> Agregar </button></td>
                                      </tr>
                                    </table></td>
                                  </tr>
                                  <tr>
